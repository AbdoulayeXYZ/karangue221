...
CREATE TABLE `incidents` (
  ...
  `status` enum('open','resolved','ignored') COLLATE utf8mb4_unicode_ci DEFAULT 'open',
  `timestamp` datetime DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('owner','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'owner',
  `phone` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `vehicles` (
  ...
  `fleet_id` int NOT NULL,
  `imei_device` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `violations` (
  ...
  `gForce` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `eyeClosure` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lateralG` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-06-20 16:40:25
